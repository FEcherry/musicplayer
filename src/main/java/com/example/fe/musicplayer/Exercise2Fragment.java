...
public class Exercise2Fragment extends Activity{
    ...
    private void initView(){
        ...
        mBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Exercise2Fragment.this,HomeActivity.class);
        ...
        mLast.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Exercise2Fragment.this,Exercise1Fragment.class);
                startActivity(intent);
        ...
        mNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Exercise2Fragment.this,Exercise3Fragment.class);
                startActivity(intent);
